  ...
  class GetIntoTeachingCallback
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `GetIntoTeachingApiClient::GetIntoTeachingCallback`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @talking_points.to_s.length < 1
        invalid_properties.push('invalid value for "talking_points", the character length must be greater than or equal to 1.')
      end
    ...
    def address_telephone=(address_telephone)
      if address_telephone.nil?
        fail ArgumentError, 'address_telephone cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] phone_call_scheduled_at Value to be assigned
    def phone_call_scheduled_at=(phone_call_scheduled_at)
      if phone_call_scheduled_at.nil?
        fail ArgumentError, 'phone_call_scheduled_at cannot be nil'
      end
    ...
    def talking_points=(talking_points)
      ...
      if talking_points.to_s.length < 1
        fail ArgumentError, 'invalid value for "talking_points", the character length must be greater than or equal to 1.'
      end
