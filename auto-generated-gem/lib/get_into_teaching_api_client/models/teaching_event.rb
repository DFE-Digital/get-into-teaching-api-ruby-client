  ...
  class TeachingEvent
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `GetIntoTeachingApiClient::TeachingEvent`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @readable_id.to_s.length < 1
        invalid_properties.push('invalid value for "readable_id", the character length must be greater than or equal to 1.')
      end
    ...
    def readable_id=(readable_id)
      ...
      if readable_id.to_s.length < 1
        fail ArgumentError, 'invalid value for "readable_id", the character length must be greater than or equal to 1.'
      end
