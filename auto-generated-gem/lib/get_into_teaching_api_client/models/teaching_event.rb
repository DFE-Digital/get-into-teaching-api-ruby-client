...
module GetIntoTeachingApiClient
  class TeachingEvent
    ...
    # Used to push miscellaneous messages to users (e.g. if an event is close to being booked out).
    ...
    def self.attribute_map
      {
        ...
        :'provider_target_audience' => :'provider_target_audience',
        :'provider_organiser' => :'provider_organiser',
