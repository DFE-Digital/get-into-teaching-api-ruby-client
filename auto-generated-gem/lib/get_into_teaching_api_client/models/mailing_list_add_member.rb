  ...
  class MailingListAddMember
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `GetIntoTeachingApiClient::MailingListAddMember`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'preferred_teaching_subject_id')
        ...
        self.preferred_teaching_subject_id = nil
      end
      ...
      if attributes.key?(:'consideration_journey_stage_id')
        ...
        self.consideration_journey_stage_id = nil
      end
    ...
    def list_invalid_properties
      ...
      if @accepted_policy_id.to_s.length < 1
        invalid_properties.push('invalid value for "accepted_policy_id", the character length must be greater than or equal to 1.')
      end
    ...
    # @param [Object] preferred_teaching_subject_id Value to be assigned
    def preferred_teaching_subject_id=(preferred_teaching_subject_id)
      if preferred_teaching_subject_id.nil?
        fail ArgumentError, 'preferred_teaching_subject_id cannot be nil'
      end
    ...
    def accepted_policy_id=(accepted_policy_id)
      ...
      if accepted_policy_id.to_s.length < 1
        fail ArgumentError, 'invalid value for "accepted_policy_id", the character length must be greater than or equal to 1.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] consideration_journey_stage_id Value to be assigned
    def consideration_journey_stage_id=(consideration_journey_stage_id)
      if consideration_journey_stage_id.nil?
        fail ArgumentError, 'consideration_journey_stage_id cannot be nil'
      end
