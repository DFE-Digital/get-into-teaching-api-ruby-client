...
module GetIntoTeachingApiClient
  class MailingListAddMember
    ...
    def self.attribute_map
      {
        ...
        :'welcome_guide_variant' => :'welcome_guide_variant',
    ...
    def self.openapi_types
      {
        ...
        :'inferred_graduation_date' => :'String'
      }
    end
    ...
    def hash
      [candidate_id, qualification_id, accepted_policy_id, consideration_journey_stage_id, preferred_teaching_subject_id, email, first_name, last_name, address_postcode, degree_status_id, graduation_year, welcome_guide_variant, channel_id, creation_channel_source_id, creation_channel_service_id, creation_channel_activity_id, situation, citizenship, visa_status, location, already_subscribed_to_events, already_subscribed_to_mailing_list, already_subscribed_to_teacher_training_adviser, inferred_graduation_date].hash
    end
