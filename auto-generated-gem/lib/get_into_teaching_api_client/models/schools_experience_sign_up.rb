...
module GetIntoTeachingApiClient
  class SchoolsExperienceSignUp
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `GetIntoTeachingApiClient::SchoolsExperienceSignUp`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'address_state_or_province')
        ...
        self.address_state_or_province = nil
      end
    ...
    def address_state_or_province=(address_state_or_province)
      if address_state_or_province.nil?
        fail ArgumentError, 'address_state_or_province cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] has_dbs_certificate Value to be assigned
    def has_dbs_certificate=(has_dbs_certificate)
      if has_dbs_certificate.nil?
        fail ArgumentError, 'has_dbs_certificate cannot be nil'
      end
