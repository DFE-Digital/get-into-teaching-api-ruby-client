...
module GetIntoTeachingApiClient
  class CandidateSchoolExperience
    ...
    def self.attribute_map
      {
        ...
        :'date_of_school_experience' => :'date_of_school_experience',
    ...
    def self.openapi_types
      {
        ...
        :'date_of_school_experience' => :'String',
    ...
    def hash
      [school_urn, duration_of_placement_in_days, date_of_school_experience, teaching_subject_id, notes, school_name, status].hash
    end
