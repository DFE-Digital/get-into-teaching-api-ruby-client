...
module GetIntoTeachingApiClient
  class CandidateSchoolExperience
    ...
    def self.swagger_types
      {
        ...
        :'date_of_school_experience' => :'DateTime',
        :'status' => :'Integer',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'durationOfPlacementInDays')
        self.duration_of_placement_in_days = attributes[:'durationOfPlacementInDays']
      end

      if attributes.has_key?(:'dateOfSchoolExperience')
        self.date_of_school_experience = attributes[:'dateOfSchoolExperience']
      end
      ...
      if attributes.has_key?(:'teachingSubjectId')
        self.teaching_subject_id = attributes[:'teachingSubjectId']
      end
