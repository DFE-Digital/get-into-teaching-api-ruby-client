...
module GetIntoTeachingApiClient
  class TeachingEventSearchRequest
    ...
    # Radius in miles to search around the postcode.
    attr_accessor :radius

    # Filter by teaching event type IDs.
    attr_accessor :type_ids

    # Set to true for online events, false for in-person events.
    attr_accessor :online

    # Filter to events starting after this date.
    attr_accessor :start_after

    # Filter to events starting before this date.
    attr_accessor :start_before

    # Filter by event status IDs.
    attr_accessor :status_ids

    # Filter by accessibility option IDs.
    ...
    def hash
      [postcode, radius, type_ids, online, start_after, start_before, status_ids, accessibility_options, quantity].hash
    end
