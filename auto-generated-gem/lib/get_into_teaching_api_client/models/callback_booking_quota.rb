  ...
  class CallbackBookingQuota
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `GetIntoTeachingApiClient::CallbackBookingQuota` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `GetIntoTeachingApiClient::CallbackBookingQuota`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'number_of_bookings')
        self.number_of_bookings = attributes[:'number_of_bookings']
      end
    ...
    def list_invalid_properties
      ...
      if @number_of_bookings.nil?
        invalid_properties.push('invalid value for "number_of_bookings", number_of_bookings cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @number_of_bookings.nil?
