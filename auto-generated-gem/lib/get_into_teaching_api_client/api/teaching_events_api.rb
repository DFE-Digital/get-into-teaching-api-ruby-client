...
module GetIntoTeachingApiClient
  class TeachingEventsApi
    ...
    def exchange_access_token_for_teaching_event_add_attendee(body, access_token, opts = {})
      data, _status_code, _headers = exchange_access_token_for_teaching_event_add_attendee_with_http_info(body, access_token, opts)
      data
    end
    ...
    def exchange_access_token_for_teaching_event_add_attendee_with_http_info(body, access_token, opts = {})
      if @api_client.config.debugging
      ...
      return_type = opts[:return_type] || 'TeachingEventAddAttendee' 
    ...
    def get_teaching_event_with_http_info(readable_id, opts = {})
      ...
      return_type = opts[:return_type] || 'TeachingEvent' 
    ...
    # @return [Array<(Array<TeachingEventsByType>, Integer, Hash)>] Array<TeachingEventsByType> data, response status code and response headers
    def search_teaching_events_grouped_by_type_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'Array<TeachingEventsByType>' 
