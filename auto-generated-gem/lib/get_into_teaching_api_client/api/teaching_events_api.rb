...
module GetIntoTeachingApiClient
  class TeachingEventsApi
    ...
    # @param teaching_event_add_attendee [TeachingEventAddAttendee] Attendee details to add.
    ...
    def exchange_access_token_for_teaching_event_add_attendee_with_http_info(access_token, existing_candidate_request, opts = {})
      ...
      # resource path
      local_var_path = '/api/teaching_events/attendees/exchange_access_token/{access_token}'.sub('{' + 'access_token' + '}', CGI.escape(access_token.to_s))
