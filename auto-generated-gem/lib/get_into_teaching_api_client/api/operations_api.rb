...
module GetIntoTeachingApiClient
  class OperationsApi
    ...
    # @param updated_since [Time] Only candidates updated since this date will be backfilled.
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def backfill_apply_candidates(updated_since, opts = {})
      backfill_apply_candidates_with_http_info(updated_since, opts)
      nil
    end
    ...
    def backfill_apply_candidates_with_http_info(updated_since, opts = {})
      ...
      if @api_client.config.client_side_validation && updated_since.nil?
        fail ArgumentError, "Missing the required parameter 'updated_since' when calling OperationsApi.backfill_apply_candidates"
      end
      # resource path
    ...
    def pause_crm_integration(opts = {})
      pause_crm_integration_with_http_info(opts)
      nil
    end
    ...
    def resume_crm_integration(opts = {})
      resume_crm_integration_with_http_info(opts)
      nil
    end
