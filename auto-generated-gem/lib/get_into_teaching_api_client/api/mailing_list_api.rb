...
module GetIntoTeachingApiClient
  class MailingListApi
    ...
    def exchange_access_token_for_mailing_list_add_member(body, access_token, opts = {})
      data, _status_code, _headers = exchange_access_token_for_mailing_list_add_member_with_http_info(body, access_token, opts)
      data
    end
    ...
    def exchange_access_token_for_mailing_list_add_member_with_http_info(body, access_token, opts = {})
      if @api_client.config.debugging
      ...
      return_type = opts[:return_type] || 'MailingListAddMember' 
