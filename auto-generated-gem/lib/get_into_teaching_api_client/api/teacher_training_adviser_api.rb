...
module GetIntoTeachingApiClient
  class TeacherTrainingAdviserApi
    ...
    def exchange_access_token_for_teacher_training_adviser_sign_up(body, access_token, opts = {})
      data, _status_code, _headers = exchange_access_token_for_teacher_training_adviser_sign_up_with_http_info(body, access_token, opts)
      data
    end
    ...
    def exchange_access_token_for_teacher_training_adviser_sign_up_with_http_info(body, access_token, opts = {})
      ...
      return_type = opts[:return_type] || 'TeacherTrainingAdviserSignUp' 
