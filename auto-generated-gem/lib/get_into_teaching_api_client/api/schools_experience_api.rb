...
module GetIntoTeachingApiClient
  class SchoolsExperienceApi
    ...
    # @param classroom_experience_note [ClassroomExperienceNote] Classroom experience note.
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def add_classroom_experience_note(id, classroom_experience_note, opts = {})
      add_classroom_experience_note_with_http_info(id, classroom_experience_note, opts)
      nil
    end
    ...
    def add_classroom_experience_note_with_http_info(id, classroom_experience_note, opts = {})
      ...
      # verify the required parameter 'classroom_experience_note' is set
      if @api_client.config.client_side_validation && classroom_experience_note.nil?
        fail ArgumentError, "Missing the required parameter 'classroom_experience_note' when calling SchoolsExperienceApi.add_classroom_experience_note"
      end
      # resource path
      local_var_path = '/api/schools_experience/candidates/{id}/classroom_experience_notes'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(classroom_experience_note)
      ...
      new_options = opts.merge(
        :operation => :"SchoolsExperienceApi.add_classroom_experience_note",
