...
```shell
gem install ./get_into_teaching_api_client-1.1.12.gem
```
(for development, run `gem install --dev ./get_into_teaching_api_client-1.1.12.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'get_into_teaching_api_client', '~> 1.1.12'
...
*GetIntoTeachingApiClient::OperationsApi* | [**patch_test**](docs/OperationsApi.md#patch_test) | **PATCH** /api/operations/patch_test | A test endpoint to see how patch requests get generated in the Ruby API client.
...
## Documentation for Models
 ...
 - [GetIntoTeachingApiClient::IContractResolver](docs/IContractResolver.md)
 - [GetIntoTeachingApiClient::JsonPatchDocument](docs/JsonPatchDocument.md)
 ...
 - [GetIntoTeachingApiClient::MailingListAddMemberJsonPatchDocument](docs/MailingListAddMemberJsonPatchDocument.md)
 - [GetIntoTeachingApiClient::MailingListAddMemberOperation](docs/MailingListAddMemberOperation.md)
 - [GetIntoTeachingApiClient::MappingInfo](docs/MappingInfo.md)
 - [GetIntoTeachingApiClient::Operation](docs/Operation.md)
