...
*GetIntoTeachingApiClient::CandidatesApi* | [**matchback_candidate**](docs/CandidatesApi.md#matchback_candidate) | **POST** /api/candidates/matchback | Perform a matchback operation, returning the match candidate id.
