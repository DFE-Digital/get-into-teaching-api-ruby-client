...
```shell
gem install ./get_into_teaching_api_client-1.0.9.gem
```
(for development, run `gem install --dev ./get_into_teaching_api_client-1.0.9.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'get_into_teaching_api_client', '~> 1.0.9'
