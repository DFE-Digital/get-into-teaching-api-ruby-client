...
# **get_candidate_describe_yourself**
> Array&lt;TypeEntity&gt; get_candidate_describe_yourself
...
begin
  #Retrieves the list of candidate consideration journey stages.
  result = api_instance.get_candidate_describe_yourself
  p result
rescue GetIntoTeachingApiClient::ApiError => e
  puts "Exception when calling TypesApi->get_candidate_describe_yourself: #{e}"
end
```
