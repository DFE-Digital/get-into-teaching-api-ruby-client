...
require 'get_into_teaching_api_client/models/mailing_list_add_member_request'
...
require 'get_into_teaching_api_client/models/teaching_event_registration_request'
